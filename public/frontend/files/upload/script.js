		...
		fetch("./", {
			...
			Data.data.forEach((File) => {
				...
				<span>
					...
					${File.deletable == true ? `<a class="enabled" id="del-${File.identifier}">delete file</a>` : `<a class="disabled">unable to delete file</a>`}
				</span>`;

				// TODO: delete image stuff
			});
